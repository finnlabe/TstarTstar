...
void TstarMassPlots(TString filename="uhh2.AnalysisModuleRunner.MC.MC_TstarTstarToTgammaTgluon_M-1500_Run2016v3.root", TString label="TstarTstarToTgammaTgluon_M-1500_Run2016v3", TString subpath="RecoPlots_After_TstarTstar",TString histname="M_Tstar_gamma"){
  gStyle->SetOptFit(0);
  gStyle->SetOptStat(0);
  ...
  filename = "uhh2.AnalysisModuleRunner.MC.MC_TstarTstarToTgammaTgluon_M-1500_Run2016v3.root";
  ...
  hist->GetXaxis()->SetTitle("M_{T*} [GeV] (reconstructed)");
  hist->GetYaxis()->SetTitle("events");
  hist->SetTitle("M_{T*} photonic");
