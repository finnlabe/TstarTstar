...
TstarTstarDNNInputHists::TstarTstarDNNInputHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
  ...
  DNN_2D_12 = book<TH1D>("DNN_Input_12", "HOTVR-1 max. sub. b-tag",  20, 0, 1);
  DNN_2D_13 = book<TH1D>("DNN_Input_13", "HOTVR-2 p_{T}",  20, 0, 3000);
  DNN_2D_14 = book<TH1D>("DNN_Input_14", "HOTVR-2 #eta",  20, -4, 4);
  DNN_2D_15 = book<TH1D>("DNN_Input_15", "HOTVR-2 #phi",  20, -4, 4);
  DNN_2D_16 = book<TH1D>("DNN_Input_16", "HOTVR-2 #tau_{1}",  20, 0, 1);
  DNN_2D_17 = book<TH1D>("DNN_Input_17", "HOTVR-2 #tau_{2}",  20, 0, 1);
  DNN_2D_18 = book<TH1D>("DNN_Input_18", "HOTVR-2 #tau_{3}",  20, 0, 1);
  DNN_2D_19 = book<TH1D>("DNN_Input_19", "HOTVR-2 N_{subjets}",  20, 0, 5);
  DNN_2D_20 = book<TH1D>("DNN_Input_20", "HOTVR-2 max. sub. b-tag",  20, 0, 1);
  DNN_2D_21 = book<TH1D>("DNN_Input_21", "HOTVR-3 p_{T}",  20, 0, 3000);
  DNN_2D_22 = book<TH1D>("DNN_Input_22", "HOTVR-3 #eta",  20, -4, 4);
  DNN_2D_23 = book<TH1D>("DNN_Input_23", "HOTVR-3 #phi",  20, -4, 4);
  DNN_2D_24 = book<TH1D>("DNN_Input_24", "HOTVR-3 #tau_{1}",  20, 0, 1);
  DNN_2D_25 = book<TH1D>("DNN_Input_25", "HOTVR-3 #tau_{2}",  20, 0, 1);
  DNN_2D_26 = book<TH1D>("DNN_Input_26", "HOTVR-3 #tau_{3}",  20, 0, 1);
  DNN_2D_27 = book<TH1D>("DNN_Input_27", "HOTVR-3 N_{subjets}",  20, 0, 5);
  DNN_2D_28 = book<TH1D>("DNN_Input_28", "HOTVR-3 max. sub b-tag",  20, 0, 1);
  DNN_2D_29 = book<TH1D>("DNN_Input_29", "neutrino p_{T}",  20, 0, 2000);
