...
TstarTstarDNNInputHists::TstarTstarDNNInputHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
  ...
  DNN_2D_4 = book<TH1D>("DNN_Input_4", "lepton relIso",  20, 0, 2);
  DNN_2D_5 = book<TH1D>("DNN_Input_5", "HOTVR-1 pt",  20, 0, 3000);
  DNN_2D_6 = book<TH1D>("DNN_Input_6", "HOTVR-1 eta",  20, -4, 4);
  DNN_2D_7 = book<TH1D>("DNN_Input_7", "HOTVR-1 phi",  20, -4, 4);
  DNN_2D_8 = book<TH1D>("DNN_Input_8", "HOTVR-1 tau1",  20, 0, 1);
  DNN_2D_9 = book<TH1D>("DNN_Input_9", "HOTVR-1 tau2",  20, 0, 1);
  DNN_2D_10 = book<TH1D>("DNN_Input_10", "HOTVR-1 tau3",  20, 0, 1);
  DNN_2D_11 = book<TH1D>("DNN_Input_11", "HOTVR-1 subjets",  20, 0, 5);
  DNN_2D_12 = book<TH1D>("DNN_Input_12", "HOTVR-1 max sub btag",  20, 0, 1);
  DNN_2D_13 = book<TH1D>("DNN_Input_13", "HOTVR-2 pt",  20, 0, 3000);
  DNN_2D_14 = book<TH1D>("DNN_Input_14", "HOTVR-2 eta",  20, -4, 4);
  DNN_2D_15 = book<TH1D>("DNN_Input_15", "HOTVR-2 phi",  20, -4, 4);
  DNN_2D_16 = book<TH1D>("DNN_Input_16", "HOTVR-2 tau1",  20, 0, 1);
  DNN_2D_17 = book<TH1D>("DNN_Input_17", "HOTVR-2 tau2",  20, 0, 1);
  DNN_2D_18 = book<TH1D>("DNN_Input_18", "HOTVR-2 tau3",  20, 0, 1);
  DNN_2D_19 = book<TH1D>("DNN_Input_19", "HOTVR-2 subjets",  20, 0, 5);
  DNN_2D_20 = book<TH1D>("DNN_Input_20", "HOTVR-2 max sub btag",  20, 0, 1);
  DNN_2D_21 = book<TH1D>("DNN_Input_21", "HOTVR-3 pt",  20, 0, 3000);
  DNN_2D_22 = book<TH1D>("DNN_Input_22", "HOTVR-3 eta",  20, -4, 4);
  DNN_2D_23 = book<TH1D>("DNN_Input_23", "HOTVR-3 phi",  20, -4, 4);
  DNN_2D_24 = book<TH1D>("DNN_Input_24", "HOTVR-3 tau1",  20, 0, 1);
  DNN_2D_25 = book<TH1D>("DNN_Input_25", "HOTVR-3 tau2",  20, 0, 1);
  DNN_2D_26 = book<TH1D>("DNN_Input_26", "HOTVR-3 tau3",  20, 0, 1);
  DNN_2D_27 = book<TH1D>("DNN_Input_27", "HOTVR-3 subjets",  20, 0, 5);
  DNN_2D_28 = book<TH1D>("DNN_Input_28", "HOTVR-3 max sub btag",  20, 0, 1);
  DNN_2D_29 = book<TH1D>("DNN_Input_29", "neutrino pt",  20, 0, 2000);
  DNN_2D_30 = book<TH1D>("DNN_Input_30", "neutrino eta",  20, -4, 4);
  DNN_2D_31 = book<TH1D>("DNN_Input_31", "neutrino phi",  20, -4, 4);
  DNN_2D_32 = book<TH1D>("DNN_Input_32", "N AK4",  20, 0, 10);
  DNN_2D_33 = book<TH1D>("DNN_Input_33", "N HOTVR",  20, 0, 10);
